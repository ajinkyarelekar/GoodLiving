...
@interface LandingFilterThemeControllerViewController ()
{
...
@implementation LandingFilterThemeControllerViewController
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LandingselectedfilterthemeViewController *theme=[[LandingselectedfilterthemeViewController alloc]init];
    ...
    switch (indexPath.row)
    {
        ...
        case 1:
            ...
            theme.DataString=currentCell.str1.text;
            break;
...
-(void)SubmitMethod
{
    ...
    [UserDefault setObject:subTitleArray forKey:@"LandingFilterSubTitleArray"];

//    NSInteger numberOfViewControllers = self.navigationController.viewControllers.count;
//    LandingfilterSubmitViewController *obj=[self.navigationController.viewControllers objectAtIndex:numberOfViewControllers - 2];
    LandingfilterSubmitViewController *obj=[[LandingfilterSubmitViewController alloc]init];
    obj.emirateString=_emiratesString;
    obj.titleString=_themeString;
