...
@interface SelectedThemesController : GAITrackedViewController <UISearchBarDelegate,UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate,UIPickerViewDataSource,UIPickerViewDelegate,UIGestureRecognizerDelegate>
{
...
@property(nonatomic)BOOL IsFromSubmitBtn;
@end
